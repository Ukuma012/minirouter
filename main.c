...
int main(int argc, char *argv[])
{
  ...
  ipv4_address_set(get_net_device("router1-host1"), IPV4_ADDRESS(192,168,1,1), IPV4_ADDRESS(255,255,255,0));
  ipv4_address_set(get_net_device("router1-router2"), IPV4_ADDRESS(192,168,0,1), IPV4_ADDRESS(255,255,255,0));
